...
<<<<<<< HEAD:Project1/ERS/src/main/java/com/revature/models/Reimbursement.java
...
=======
	...
	public Reimbursement(int id, double amt, Timestamp submit, Timestamp approved, int author, int resolve, int stat, int type) {
		...
		this.statusID = stat;
		this.typeID = type;
>>>>>>> 4a5cf503d94e1f1c3c5496435d2db9912d6759e2:ExpenseReimbSys/src/main/java/com/revature/models/Reimbursement.java
	}
